...
def main():         
    try:
        ...
        root = CTk()
        root.title(f'ADM - BARBEARIA ENTRE AMIGOS - {version} - RayTec Soluções em Software - Todos Direitos Reservados 2024 ®')
        ...
        #play da tela    
        app = MainInterface(root, dimensoes[0], dimensoes[1], version)
        root.mainloop()
